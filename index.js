...
async function startA17() {
  ...
  console.log(color('\nHello, I am Asif, the Developer of this bot.\n\nThanks for using: AmazBot.', 'aqua'))
  console.log(color('\nYou can follow me on github', 'aqua'))

  const { state, saveCreds } = await useMultiFileAuthState("./AMAZ-SESSION");
  const A17 = A17Connect({
    logger: pino({ level: "silent" }),
    printQRInTerminal: true,
    browser: ["AMAZ-MD", "Safari", "3.O"],
    auth: state,
  });
